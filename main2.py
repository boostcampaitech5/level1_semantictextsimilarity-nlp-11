...
if __name__ == '__main__':
    ...
    Train_textDataset = Train_val_TextDataset('train','./data/augment.csv',['sentence_1', 'sentence_2'],'label','binary-label',max_length=256,model_name=model_name)
    ...
    args = TrainingArguments(
        "E:/nlp/checkpoint/elector/king_sang",
