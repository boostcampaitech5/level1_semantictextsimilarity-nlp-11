...
if __name__ == "__main__":
    ...
    parameters_dict = {
        ...
        "learning_schedule": {"values": ["cosine", "linear"]},
    }
    ...
    Train_textDataset = Train_val_TextDataset(
        "./data/best_data_v1.csv",
        "train",
    ...
    Val_textDataset = Train_val_TextDataset(
        "./data/dev.csv",
        "val",
        ["sentence_1", "sentence_2"],
        "label",
    ...
    def model_init():
        model = AutoModelForSequenceClassification.from_pretrained(
            "xlm-roberta-large", num_labels=1, ignore_mismatched_sizes=True
        )
        return model
